    ...
    @autoreleasepool {
        ...
        if (self) {
            ...
            if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone){
                ...
                _delegate = delegate;
                [_view setBackgroundColor:[UIColor colorWithRed:0 green:0 blue:0 alpha:0.6]];
            ...
            for (int i = 0; i < _numberOfButtons; i++){
                ...
                UILabel *currentLabel = [[[UILabel alloc] initWithFrame:CGRectMake(currentButton.frame.origin.x - lOffsetText, currentY + sizeButtons.height, wText, hText)] autorelease];
            ...
            if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPad){
                ...
                [[[_popoverController contentViewController] view] setAlpha:0.25f];
            }
